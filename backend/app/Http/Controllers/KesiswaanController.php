...
class KesiswaanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $staf = Kesiswaan::create($validatedData);
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        $kesiswaan->status = $request->status;
        $kesiswaan->save();
    ...
    {
        $kesiswaan = Kesiswaan::find($id);

        if ($kesiswaan) {
            // Sembunyikan created_at dan updated_at
            $kesiswaan->makeHidden(['created_at', 'updated_at', 'id', 'status', 'tujuan','read']);
